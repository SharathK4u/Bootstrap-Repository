						...
						<div class="col-xl-12 col-lg-12">
							<div class="card shadow mb-4">
								...
								<div class="card-body">
									...
									<form:form modelAttribute="employee" onsubmit="return fnValidate();" method="post"
										...
										<div class="form-group row">
											...
											<div class="col-lg-4 col-xl-4 ">
													<form:errors path="firstName" class="form-control alert alert-warning"/>
											</div>
										</div>
										<div class="form-group row">
										...
										<div class="form-group row">
											...
											<div class="col-lg-4 col-xl-4 ">
													<form:errors path="emailId" class="form-control alert alert-warning"/>
											</div>
										</div>
										<div class="form-group row">
										...
										<div class="form-group row">
											...
											<div class="col-lg-6 col-xl-6">
												<form:input type="number" class="form-control" required="text" id="salary"
